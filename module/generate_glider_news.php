...
<?php
	...
	foreach($re as $value){
		...
		echo'<a href="/news?pub='.$value['id'].'"<button class="button is-link is-rounded " style="margin: 2vw 0 -2vw; position: relative;left: 50%;transform: translate(-50%, 0); width:10vw;">Подробнее</button></a>';
